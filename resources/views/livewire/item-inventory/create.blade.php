        ...
        <div class="w-full px-3 mb-6 e">
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="flex-auto p-4">
                    ...
                    <h5 class="font-bold py-3">Item Inventory Form</h5>
                        ...
                        <div class="flex flex-wrap -mx-3">
                            <div class="max-w-full px-3 w-1/2 lg:flex-none">
                                <div class="flex flex-col h-full">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @empty
                                            <option value="-1">No item found</option>
                                        @endforelse
                                           
                                        </select>
                                        @error('item_id') <p class="text-size-sm text-red-500">{{ $message }}</p>
                                        @enderror
                                    </div>
                                </div>
                            </div>  
                            ...
                            <div class="max-w-full px-3 w-1/2 lg:flex-none">
                                <div class="flex flex-col h-full">
                                    ...
                                    <h6 class="font-bold leading-tight uppercase text-size-xs text-slate-500">
                                        Quantity <small> (Enter negative number to reduce Qty.)</small>
                                    </h6>
